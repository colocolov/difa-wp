...
$opt_name = 'difa_options';  // YOU MUST CHANGE THIS.  DO NOT USE 'redux_demo' IN YOUR PROJECT!!!
...
Redux::set_section(
	$opt_name,
	array(
		'title'            => esc_html__( 'Global Settings', 'difa' ),
		'id'               => 'globalsettings',
		'desc'             => esc_html__( 'Option for site', 'difa' ),
...
Redux::set_section(
	...
	array(
		...
		'subsection' => true,
		'desc'       => esc_html__( 'Entry Your Social Profiles', 'difa' ),
		'fields'     => array(
			array(
